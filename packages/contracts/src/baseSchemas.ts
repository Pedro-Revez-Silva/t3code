...
export const SupervisorGoalId = makeEntityId("SupervisorGoalId");
export type SupervisorGoalId = typeof SupervisorGoalId.Type;
export const SupervisorGoalTaskId = makeEntityId("SupervisorGoalTaskId");
export type SupervisorGoalTaskId = typeof SupervisorGoalTaskId.Type;
export const SupervisorTaskAttemptId = makeEntityId("SupervisorTaskAttemptId");
export type SupervisorTaskAttemptId = typeof SupervisorTaskAttemptId.Type;
