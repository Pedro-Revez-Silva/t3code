...
export const ProviderAdapterV2Event = Schema.Union([
  ...
  Schema.Struct({
    type: Schema.Literal("provider_thread.resume_requested"),
    driver: ProviderDriverKind,
    parentProviderThreadId: ProviderThreadId,
    parentProviderTurnId: ProviderTurnId,
    childProviderThreadId: ProviderThreadId,
    childThreadId: ThreadId,
    nativeItemId: Schema.String,
    nativeTurnIdBarrier: Schema.String,
  }),
  Schema.Struct({
    type: Schema.Literal("provider_thread.resume_confirmed"),
    driver: ProviderDriverKind,
    parentProviderThreadId: ProviderThreadId,
    parentProviderTurnId: ProviderTurnId,
    childProviderThreadId: ProviderThreadId,
    ...
    nativeItemId: Schema.String,
    nativeTurnIdBarrier: Schema.String,
    nativeChildTurnId: Schema.String,
  }),
  Schema.Struct({
