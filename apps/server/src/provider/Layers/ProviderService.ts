  ...
  const startSession: ProviderServiceShape["startSession"] = Effect.fn("startSession")(
    function* (threadId, rawInput) {
      ...
      return yield* Effect.gen(function* () {
        ...
        const persisted = yield* resolvePersistedProviderState(
          threadId,
          resolvedProvider,
          resolvedInstanceId,
        );
        const effectiveResumeCursor =
          input.resumeCursor ?? persisted.binding?.resumeCursor ?? persisted.mirror?.resumeCursor;
        const effectiveCwd =
          input.cwd ??
        ...
        yield* Effect.annotateCurrentSpan({
          ...
          "provider.resume_cursor.source":
            input.resumeCursor !== undefined
              ? "request"
              : effectiveResumeCursor !== undefined && persisted.binding !== undefined
                ? "persisted-binding"
                : effectiveResumeCursor !== undefined && persisted.mirror !== undefined
                  ? "persisted-mirror"
                  : "none",
          "provider.model_selection.source":
            input.modelSelection !== undefined
              ? "request"
              : effectiveModelSelection !== undefined && persisted.binding !== undefined
                ? "persisted-binding"
                : effectiveModelSelection !== undefined && persisted.mirror !== undefined
                  ? "persisted-mirror"
                  : "none",
          ...
          "provider.cwd.source":
            input.cwd !== undefined
              ? "request"
              : effectiveCwd !== undefined && persisted.binding !== undefined
                ? "persisted-binding"
                : effectiveCwd !== undefined && persisted.mirror !== undefined
                  ? "persisted-mirror"
                  : "none",
